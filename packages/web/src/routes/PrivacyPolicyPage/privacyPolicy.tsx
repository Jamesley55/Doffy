	...
	return (
		<View>
			...
			<View style={CustomStyle.Policy}>
				...
				<p>Last updated: August 14, 2020</p>
				...
				<ul>
					...
					<li>
						<p>
							...
							"We", "Us" or "Our" in this Agreement) refers to Doffy.
						</p>
					</li>
					<li>
					...
					<li>
						<strong>Website</strong> refers to Doffy, accessible from
						http://DONXIQUOTE.COM
					</li>
					<li>
				...
				<ul>
					<li>By email: doffyinc@gmail.com</li>
				</ul>
			</View>
