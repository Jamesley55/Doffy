...
export function schedulePage({
	...
	const [mondayStart, setMondayStart] = React.useState("09:05");
	const [tuesdayStart, setTuesdayStart] = React.useState("09:05");
	const [wednesdayStart, setWednesdayStart] = React.useState("09:05");
	const [thursdayStart, setThursdayStart] = React.useState("09:05");
	const [fridayStart, setFridayStart] = React.useState("09:05");
	const [saturdayStart, setSaturdayStart] = React.useState("09:05");
